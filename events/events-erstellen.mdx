...
Event-Details, die in einer speziellen Form angezeigt/formatiert werden, sind in [Besondere Event Details](/events/events-erstellen/besondere-event-details) beschrieben.
