...
No setup required. Once the bot has [joined the server](https://slotbot.de/invite), we are ready to go.

## Feature overview

The Discord integration allows the events to be displayed in channels. Participants can register without leaving Discord and receive notifications before the event starts. There is also an overview of all past events. All events are displayed at the top of the channel list under the 'Events' heading.
