...
_By the way: If your community is invited to an event, or if you add an event to your own Discord server, it will also appear directly in the [Event Calendar](/en/events/event-calendar)._
