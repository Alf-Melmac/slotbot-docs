...
We want to help **communities** focus on their **events** by providing a simple yet powerful platform for organising them.
...
To encourage as many registrations as possible, the process has been fully simplified. Three short steps are all that's needed for the event planners to provide all the important information, without any question left unanswered.
...
<Columns cols={3}>
	<Card title={"Calendar"} href={"/en/events/event-calendar"} img={"/images/start/start-calendar.png"}>
		Discover event overview and details
	</Card>
	...
	<Card title={"Reminders"} href={"/en/integrations/discord/reminders"}
		...
		Set reminders to never miss an event again
	</Card>
...
<Columns cols={2}>
	...
	<Card title={"Other calendars"} href={"/en/integrations/calendar-sync"}
