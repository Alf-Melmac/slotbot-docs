...
Beim Login mit Discord speichern wir die Discord-User-ID und setzen zur Aufrechterhaltung des Logins technisch notwendige [Cookies](/policies/datenschutzerklärung/cookies) im Browser.
...
<Info>
	Ergänzend hierzu, jedoch nicht Teil der Erklärung, gelten für die an anderer Stelle verwalteten Domains die folgende Impressumsangaben:
	- [events.deutsche-arma-allianz.de](https://events.deutsche-arma-allianz.de) -> [deutsche-arma-allianz.de/impressum](https://www.deutsche-arma-allianz.de/impressum.html)
	- [events.tacticalteam.de](https://events.tacticalteam.de) -> [tacticalteam.de/impressum](https://tacticalteam.de/impressum)
</Info>
