...
* (Optional, aber empfohlen) **Rollen verwalten**, um Änderungen der Berechtigungen von [Community-Mitgliedern](/communities/übersicht#spieler) in den zugewiesenen Discord-Rollen widerzuspiegeln.
